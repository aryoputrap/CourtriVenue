...
class DropDownPicker extends React.Component {
  ...
  getLabel(item, selected = false) {
    ...
    let len2 = name.length;
    return name + (len !== len2 ? '...' : '');
  }
  ...
  render() {
    ...
    const isPlaceholderActive =
      this.state.choice.name === null ||
      (Array.isArray(this.state.choice) && this.state.choice.length === 0);
    const name = isPlaceholderActive
      ? placeholder
      : this.getLabel(this.state.choice?.name, true);
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              ...
              this.props.labelStyle,
              this.state.choice.name !== null && this.props.selectedLabelStyle,
              placeholderStyle,
            ]}
            {...this.props.labelProps}>
            {multiple
        ...
        <View
          ...
          {this.props.searchable && (
            <View
              ...
              {/* <Image source={SearchDrop} style={{ marginTop: 11, marginRight: 10}}/> */}
              <TextInput
                style={[
                  //   styles.input,
                  this.props.globalTextStyle,
